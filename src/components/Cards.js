...
function Cards({amount = 3}) {
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8' id="exemplos">
            { Array.from({ length: amount }).map((_, index) => (
                <div className='border border-gray-700 shadow-lg rounded-lg overflow-hidden bg-slate-700 bg-opacity-75'>
                    ...
                    <div className='p-4'>
                        ...
                        <p className='text-gray-300 mb-4'>Descrição do card com tema escuro e transparência.</p>
